...
import com.alipay.sofa.jraft.example.finalProjectTask1.SnapshotFile;
...
import static com.alipay.sofa.jraft.example.finalProjectTask1.CounterOperation.GET;
import static com.alipay.sofa.jraft.example.finalProjectTask1.CounterOperation.SET;
...
public class CounterStateMachine extends StateMachineAdapter {
    ...
    public void onApply(final Iterator iter) {
        while (iter.hasNext()) {
            long current = 0;
            com.alipay.sofa.jraft.example.finalProjectTask1.CounterOperation counterOperation = null;

            com.alipay.sofa.jraft.example.finalProjectTask1.CounterClosure closure = null;
            if (iter.done() != null) {
